...
//    mkdir($pathUser, 0777);
//}
$pathYear = $root . '/upload/' . $year . '/';
if (!is_dir($pathYear)) {
    mkdir($pathYear, 0777);
}
$pathMonth = $root . '/upload/' . $year . '/' . $month . '/';
if (!is_dir($pathMonth)) {
    mkdir($pathMonth, 0777);
}
$pathDay = $root . '/upload/' . $year . '/' . $month . '/' . $day . '/';
if (!is_dir($pathDay)) {
    mkdir($pathDay, 0777);
}
$url_to_files = '/upload/' . $year . '/' . $month . '/' . $day . '/';
...
$opts = array(
    ...
    'roots' => array(
        array(
            ...
            'path'          => $pathDay,         // path to files (REQUIRED)
