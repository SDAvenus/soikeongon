                                            ...
                                            <div class="form-group">
                                                ...
                                                <table class="table table-responsive-sm table-bordered text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @endforeach
                                                        <tr>
                                                            <td class="text-left">Cấu hình đá gà</td>
                                                            <td></td>
                                                            <td></td>
                                                            <td>
                                                                <div class="form-check checkbox">
                                                                    <input class="form-check-input" name="permission[site_setting][updateSettingDaGa]" {{!empty($permission['site_setting']) && array_key_exists('updateSettingDaGa', $permission['site_setting']) ? 'checked' : ''}} type="checkbox">
                                                                </div>
                                                            </td>
                                                            <td></td>
                                                            <td></td>
