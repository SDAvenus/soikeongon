                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label>Mô tả</label>
                                                <textarea class="form-control context" name="description" rows="4" placeholder="Mô tả">{{!empty($oneItem->description) ? $oneItem->description : ''}}</textarea>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="slug" value="{{!empty($oneItem->slug) ? $oneItem->slug : ''}}" type="text" placeholder="Slug url">
                                    </div>
                                    <div class="form-group">
